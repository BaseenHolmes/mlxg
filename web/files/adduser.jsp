    ...
    <script type="text/javascript">
        function pnoo(obj) {
            ...
            if (a.length == 0) {
                ...
                activeX.open("post", "http://localhost:8081/mlxg/servlet/PersonInfoServlet?methodName=isperson&pnoo=" + a, true);
                //回调函数
        ...
        function baocun() {
            ...
            if (pno == "") {
                ...
                var path = "http://localhost:8081/mlxg/servlet/PersonInfoServlet?methodName=InsertpersonInfo";
...
<form method="post" name="form" id="form">
    <input type="hidden" value="1572357407104" name="token">
    <div class="MainDiv">
                                ...
                                <fieldset style="height: 100%;">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1"
                                        ...
                                        <tr>
                                            ...
                                            <td width="34%">
                                                <input type="text" id="pno" name="pno" style="width: 154px"
                                                       onblur="pnoo(this);" value=""><font id="pnodiv"
                                                                                           color="red">*</font>
                                            </td>
                                            <td width="16%" align="right" nowrap="nowrap">
                                                密码:
                                            ...
                                            <td width="34%">
                                                <input type="password" id="password" name='ppassword'
                                                       style="width: 154px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="text" name='pbirthday' id="pbirthday"
                                                       style="width: 154px" value=""/><font
                                                    color="red">*（格式：yyyy-mm-dd）</font>
                                            </td>
                                            <td align="right">
                                                身份证号码:
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="text" name='paddr' style="width: 154px" id="paddr"
                                                       value=""/>
                                            </td>
                                            <td align="right">
                                                员工类型:
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <textarea name="pdescription" cols="100" rows="8" id="pdescription"
                                                          onkeyup="zx();"></textarea><font size="2px" id="sy"
                                                                                           color="blue">剩余(300)字</font>
                                            </td>
                                        </tr>
                                    </table>
                                    <br/>
