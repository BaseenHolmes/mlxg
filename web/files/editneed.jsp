...
<%--
   @Description: TODO 
   @Author Baseen
   @Date Created in 2019/10/28 12:56
   @Version v1.0
--%>
        ...
        $(document).ready(function () {
            $("#save").click(function () {
                ...
                if (r == true) {
                    ...
                    $("#fom").attr("action", "http://localhost:8080/mlxg/need.do?method=doEditNeed&nno=${requestScope.need.needid}");
                    $("#fom").submit();
                } else {
                    return false;
                }
            ...
            <tr>
                <td class="CPanel">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                        ...
                        <tr align="center">
                            <td class="TablePanel">${requestScope.need.projectname}</td>
                        </tr>
                        <TR>
                            <TD width="100%">
                                <fieldset style="height:100%;">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%"><input type="text" name="title" id="title"
                                                                   value="${requestScope.need.nname}"/><span
                                                    class="red">*</span><br>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"><textarea name="neirong" cols="100"
                                                                      rows="20">${requestScope.need.ntext}</textarea>
                                            </td>
                                        </tr>
                                    </table>
                                    <br/>
